            ...
            <div class="box"> <!-- box Begin -->
                ...
                <form action="confirm.php?update_id=<?php echo $order_id ?>" method="post" enctype="multipart/form-data"> <!-- form Begin -->
                    ...
                    <div class="text-center"> <!-- text-center Begin -->
                        ...
                        <button class="btn btn-primary btn-lg" name="confirm_details"> <!-- btn btn-primary btn-lg Begin -->

                            <i class="fa fa-user-md"></i> Confirm Details
                ...
                if(isset($_POST['confirm_details'])){
                    ...
                    $update_customer_order = "update customer_orders set order_status='$cod' where order_id='$update_id'";

                    $run_customer_order = mysqli_query($con,$update_customer_order);

                    $update_pending_order = "update pending_orders set order_status='$cod' where order_id='$update_id'";
