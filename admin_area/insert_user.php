...
if(isset($_POST['submit'])){
    ...
    (admin_name,admin_email,admin_pass,admin_address,admin_contact,admin_job,admin_image,admin_about) values
     ('$user_name', '$user_email','$user_pass','$user_address','$user_contact','$user_job','$user_image','$user_about')"; 

     $run_user = mysqli_query($con,$insert_user);

     if($run_user){

        echo "<script>alert('User has been inserted as an admin successfully')</script>";
