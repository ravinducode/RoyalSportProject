                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_order=mysqli_fetch_array($run_orders)){
                                    ...
                                    $get_details = "select * from cod_payments where invoice_no='$invoice_no'";
                                    ...
                                    $phonenumber = $row_details['phone_number'];
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        if($order_status=='Cash On Delivery'){
                                            
                                            echo $order_status='Cash On Delivery';
                                            
                                        }else{
                                            
                                            echo $order_status='Cash On Delivery Completed';
