...
<?php 
    ...
    if(isset($_GET['edit_slide'])){
        ...
        $edit_slide = "select * from event_slider where slider_id='$edit_slide_id'";
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        $update_slide = "update event_slider set slider_name='$slider_name',slider_image='$slider_image' where slider_id='$slider_id'";
