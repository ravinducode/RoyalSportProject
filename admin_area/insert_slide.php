    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Events and Offers Slides
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Events and Offers Slides
...
<?php  
        ...
        if(isset($_POST['submit'])){
            ...
            $view_slides = "select * from event_slider";
            ...
            if($count<4){
                ...
                $insert_slide = "insert into event_slider (slider_name,slider_image) values ('$slide_name','$slide_image')";
